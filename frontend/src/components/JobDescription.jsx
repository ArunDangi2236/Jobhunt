    ...
    return (
        ...
        <h1 className='border-b-2 border-b-gray-300 font-medium py-4'>Job Description</h1>
            <div className='my-4'>
                ...
                <h1 className='font-bold my-1 '>Experience:<span className='pl-4 font-normal'>{singleJob?.experienceLevel} years</span></h1>
                ...
                <h1 className='font-bold my-1 '>Posted Date:<span className='pl-4 font-normal'>{singleJob?.createdAt}</span></h1>
            </div>
        </div>
    )
}
